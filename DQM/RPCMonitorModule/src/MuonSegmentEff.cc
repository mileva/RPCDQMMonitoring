...
MuonSegmentEff::MuonSegmentEff(const edm::ParameterSet& iConfig)
{
  ...
  AlignmentinfoFile = iConfig.getUntrackedParameter<std::string> ("AliFileName",
      "/afs/cern.ch/user/c/carrillo/segments/CMSSW_2_2_10/src/DQM/RPCMonitorModule/data/Alignment.dat");
  ...
  if (debug)
    std::cout << "booking Global histograms Change statistics" << std::endl;
  ...
  DistBorderClu1La1 = dbe->book1D("DistBorderClu1La1", "Distance to the Border of the Strip Layer 1 Cluster Size 1",
      200, -2., 3.);
  DistBorderClu1La2 = dbe->book1D("DistBorderClu1La2", "Distance to the Border of the Strip Layer 2 Cluster Size 1",
      200, -2., 3.);
  DistBorderClu1La3 = dbe->book1D("DistBorderClu1La3", "Distance to the Border of the Strip Layer 3 Cluster Size 1",
      200, -2., 3.);
  DistBorderClu1La4 = dbe->book1D("DistBorderClu1La4", "Distance to the Border of the Strip Layer 4 Cluster Size 1",
      200, -2., 3.);
  DistBorderClu1La5 = dbe->book1D("DistBorderClu1La5", "Distance to the Border of the Strip Layer 5 Cluster Size 1",
      200, -2., 3.);
  DistBorderClu1La6 = dbe->book1D("DistBorderClu1La6", "Distance to the Border of the Strip Layer 6 Cluster Size 1",
      200, -2., 3.);

  DistBorderClu2La1 = dbe->book1D("DistBorderClu2La1", "Distance to the Border of the Strip Layer 1 Cluster Size 2",
      200, -2., 3.);
  DistBorderClu2La2 = dbe->book1D("DistBorderClu2La2", "Distance to the Border of the Strip Layer 2 Cluster Size 2",
      200, -2., 3.);
  DistBorderClu2La3 = dbe->book1D("DistBorderClu2La3", "Distance to the Border of the Strip Layer 3 Cluster Size 2",
      200, -2., 3.);
  DistBorderClu2La4 = dbe->book1D("DistBorderClu2La4", "Distance to the Border of the Strip Layer 4 Cluster Size 2",
      200, -2., 3.);
  DistBorderClu2La5 = dbe->book1D("DistBorderClu2La5", "Distance to the Border of the Strip Layer 5 Cluster Size 2",
      200, -2., 3.);
  DistBorderClu2La6 = dbe->book1D("DistBorderClu2La6", "Distance to the Border of the Strip Layer 6 Cluster Size 2",
      200, -2., 3.);

  DistBorderClu3La1 = dbe->book1D("DistBorderClu3La1", "Distance to the Border of the Strip Layer 1 Cluster Size 3",
      200, -2., 3.);
  DistBorderClu3La2 = dbe->book1D("DistBorderClu3La2", "Distance to the Border of the Strip Layer 2 Cluster Size 3",
      200, -2., 3.);
  DistBorderClu3La3 = dbe->book1D("DistBorderClu3La3", "Distance to the Border of the Strip Layer 3 Cluster Size 3",
      200, -2., 3.);
  DistBorderClu3La4 = dbe->book1D("DistBorderClu3La4", "Distance to the Border of the Strip Layer 4 Cluster Size 3",
      200, -2., 3.);
  DistBorderClu3La5 = dbe->book1D("DistBorderClu3La5", "Distance to the Border of the Strip Layer 5 Cluster Size 3",
      200, -2., 3.);
  DistBorderClu3La6 = dbe->book1D("DistBorderClu3La6", "Distance to the Border of the Strip Layer 6 Cluster Size 3",
      200, -2., 3.);

  //Ang Dependence

  ScatterPlotAlphaCLSLa1 = dbe->book2D("ScatterPlotAlphaCLSLa1",
      "Scatter Plot Incident Angle and Cluster Size Layer 1", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaCLSLa2 = dbe->book2D("ScatterPlotAlphaCLSLa2",
      "Scatter Plot Incident Angle and Cluster Size Layer 2", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaCLSLa3 = dbe->book2D("ScatterPlotAlphaCLSLa3",
      "Scatter Plot Incident Angle and Cluster Size Layer 3", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaCLSLa4 = dbe->book2D("ScatterPlotAlphaCLSLa4",
      "Scatter Plot Incident Angle and Cluster Size Layer 4", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaCLSLa5 = dbe->book2D("ScatterPlotAlphaCLSLa5",
      "Scatter Plot Incident Angle and Cluster Size Layer 5", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaCLSLa6 = dbe->book2D("ScatterPlotAlphaCLSLa6",
      "Scatter Plot Incident Angle and Cluster Size Layer 6", 50, 0., 180., 7, 0.5, 7.5);

  ScatterPlotAlphaPCLSLa1 = dbe->book2D("ScatterPlotAlphaPCLSLa1",
      "Scatter Plot Incident Perpendicular Angle and Cluster Size Layer 1", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaPCLSLa2 = dbe->book2D("ScatterPlotAlphaPCLSLa2",
      "Scatter Plot Incident Perpendicular Angle and Cluster Size Layer 2", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaPCLSLa3 = dbe->book2D("ScatterPlotAlphaPCLSLa3",
      "Scatter Plot Incident Perpendicular Angle and Cluster Size Layer 3", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaPCLSLa4 = dbe->book2D("ScatterPlotAlphaPCLSLa4",
      "Scatter Plot Incident Perpendicular Angle and Cluster Size Layer 4", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaPCLSLa5 = dbe->book2D("ScatterPlotAlphaPCLSLa5",
      "Scatter Plot Incident Perpendicular Angle and Cluster Size Layer 5", 50, 0., 180., 7, 0.5, 7.5);
  ScatterPlotAlphaPCLSLa6 = dbe->book2D("ScatterPlotAlphaPCLSLa6",
      "Scatter Plot Incident Perpendicular Angle and Cluster Size Layer 6", 50, 0., 180., 7, 0.5, 7.5);
  ...
  if (debug)
    std::cout << "Booking Residuals for EndCap" << std::endl;
  folder = "Muons/MuonSegEff/Residuals/EndCap";
  dbe->setCurrentFolder(folder);

  //Endcap
  hGlobalResClu1R3C = dbe->book1D("GlobalResidualsClu1R3C", "RPC Residuals Ring 3 Roll C Cluster Size 1", 101, -10.,
      10.);
  hGlobalResClu1R3B = dbe->book1D("GlobalResidualsClu1R3B", "RPC Residuals Ring 3 Roll B Cluster Size 1", 101, -10.,
      10.);
  hGlobalResClu1R3A = dbe->book1D("GlobalResidualsClu1R3A", "RPC Residuals Ring 3 Roll A Cluster Size 1", 101, -10.,
      10.);
  hGlobalResClu1R2C = dbe->book1D("GlobalResidualsClu1R2C", "RPC Residuals Ring 2 Roll C Cluster Size 1", 101, -10.,
      10.);
  hGlobalResClu1R2B = dbe->book1D("GlobalResidualsClu1R2B", "RPC Residuals Ring 2 Roll B Cluster Size 1", 101, -10.,
      10.);
  hGlobalResClu1R2A = dbe->book1D("GlobalResidualsClu1R2A", "RPC Residuals Ring 2 Roll A Cluster Size 1", 101, -10.,
      10.);

  hGlobalResClu2R3C = dbe->book1D("GlobalResidualsClu2R3C", "RPC Residuals Ring 3 Roll C Cluster Size 2", 101, -10.,
      10.);
  hGlobalResClu2R3B = dbe->book1D("GlobalResidualsClu2R3B", "RPC Residuals Ring 3 Roll B Cluster Size 2", 101, -10.,
      10.);
  hGlobalResClu2R3A = dbe->book1D("GlobalResidualsClu2R3A", "RPC Residuals Ring 3 Roll A Cluster Size 2", 101, -10.,
      10.);
  hGlobalResClu2R2C = dbe->book1D("GlobalResidualsClu2R2C", "RPC Residuals Ring 2 Roll C Cluster Size 2", 101, -10.,
      10.);
  hGlobalResClu2R2B = dbe->book1D("GlobalResidualsClu2R2B", "RPC Residuals Ring 2 Roll B Cluster Size 2", 101, -10.,
      10.);
  hGlobalResClu2R2A = dbe->book1D("GlobalResidualsClu2R2A", "RPC Residuals Ring 2 Roll A Cluster Size 2", 101, -10.,
      10.);

  hGlobalResClu3R3C = dbe->book1D("GlobalResidualsClu3R3C", "RPC Residuals Ring 3 Roll C Cluster Size 3", 101, -10.,
      10.);
  hGlobalResClu3R3B = dbe->book1D("GlobalResidualsClu3R3B", "RPC Residuals Ring 3 Roll B Cluster Size 3", 101, -10.,
      10.);
  hGlobalResClu3R3A = dbe->book1D("GlobalResidualsClu3R3A", "RPC Residuals Ring 3 Roll A Cluster Size 3", 101, -10.,
      10.);
  hGlobalResClu3R2C = dbe->book1D("GlobalResidualsClu3R2C", "RPC Residuals Ring 2 Roll C Cluster Size 3", 101, -10.,
      10.);
  hGlobalResClu3R2B = dbe->book1D("GlobalResidualsClu3R2B", "RPC Residuals Ring 2 Roll B Cluster Size 3", 101, -10.,
      10.);
  hGlobalResClu3R2A = dbe->book1D("GlobalResidualsClu3R2A", "RPC Residuals Ring 2 Roll A Cluster Size 3", 101, -10.,
      10.);
  ...
  if (debug)
    std::cout << "Rejected done" << std::endl;
...
//rumi
  ...
  { //Filling DQMOccupancies
    ...
    {
      if (rpcStation == 1)
        stationstatistics->Fill(14);
      if (rpcStation == 2)
        stationstatistics->Fill(15);
      if (rpcStation == 3)
        stationstatistics->Fill(16);
      if (rpcStation == 4)
        stationstatistics->Fill(17);
    }
  }
  ...
  { //No Empty Predictions
    ...
    for (rpcPoint = rpcDTPoints->begin(); rpcPoint != rpcDTPoints->end(); rpcPoint++)
    {
      ...
      if (debug)
        std::cout << "DT  \t \t \t \t The RPCName is " << nameRoll << std::endl;
      const float stripPredicted = rollasociated->strip(LocalPoint(PointExtrapolatedRPCFrame.x(),
          PointExtrapolatedRPCFrame.y(), 0.));//

      if (debug)
        std::cout << "DT  \t \t \t \t Candidate (from DT Segment) STRIP---> " << stripPredicted << std::endl;
      ...
      if (fabs(PointExtrapolatedRPCFrame.x()) < rsize * 1.5 && fabs(PointExtrapolatedRPCFrame.y()) < stripl * 1.5)
      {
        if (fabs(stripPredicted - rollasociated->nstrips()) < 1.)
          if (debug)
            std::cout << "DT \t \t \t \t Extrapolating near last strip, Event" << iEvent.id() << " stripPredicted="
                << stripPredicted << " Number of strips=" << rollasociated->nstrips() << std::endl;
        if (fabs(stripPredicted) < 1.)
          if (debug)
            std::cout << "DT \t \t \t \t Extrapolating near first strip, Event" << iEvent.id() << " stripPredicted="
                << stripPredicted << " Number of strips=" << rollasociated->nstrips() << std::endl;
      ...
      {
        if (debug)
          std::cout << "DT \t \t \t \t In fact the extrapolation goes outside the roll was done just for 2D histograms"
              << std::endl;
      }
      ...
      {
        if (debug)
          std::cout << "DT \t \t \t \t \t THIS ROLL DOESN'T HAVE ANY RECHIT" << std::endl;
      }
      else
      {
        assert(minres != 3000);
        if (debug)
          std::cout << "DT  \t \t \t \t \t PointExtrapolatedRPCFrame.x=" << PointExtrapolatedRPCFrame.x()
              << " Minimal Residual=" << minres << std::endl;
        if (debug)
          std::cout << "DT  \t \t \t \t \t Minimal Residual less than stripw*rangestrips? minres=" << minres
              << " range=" << rangestrips << " stripw=" << stripw << " cluSize" << cluSize << " <=compare minres with"
      ...
      if (prediction && anycoincidence)
      {
        ...
        if (debug)
          std::cout << "DT  \t \t \t \t \t At least one RecHit inside the range, Predicted=" << stripPredicted
              << " minres=" << minres << "cm range=" << rangestrips << "strips stripw=" << stripw << "cm" << std::endl;
        if (debug)
          std::cout << "DT  \t \t \t \t \t Norm of Cosine Directors=" << dx * dx + dy * dy + dz * dz << "~1?"
              << std::endl;
        ...
        if (inves)
        {
          ...
          if (debug)
            std::cout << "DT \t \t \t \t \t Angle=" << angle << " degree" << std::endl;

          //Filling Residuals
          if (rpcId.station() == 1 && rpcId.layer() == 1)
          {
            if (cluSize == 1 * dupli)
            {
              hGlobalResClu1La1->Fill(minres);
            }
            if (cluSize == 2 * dupli)
            {
              hGlobalResClu2La1->Fill(minres);
            }
            if (cluSize == 3 * dupli)
            {
              hGlobalResClu3La1->Fill(minres);
            }
          }
          else if (rpcId.station() == 1 && rpcId.layer() == 2)
          {
            if (cluSize == 1 * dupli)
            {
              hGlobalResClu1La2->Fill(minres);
            }
            if (cluSize == 2 * dupli)
            {
              hGlobalResClu2La2->Fill(minres);
            }
            if (cluSize == 3 * dupli)
            {
              hGlobalResClu3La2->Fill(minres);
            }
          }
          else if (rpcId.station() == 2 && rpcId.layer() == 1)
          {
            if (cluSize == 1 * dupli)
            {
              hGlobalResClu1La3->Fill(minres);
            }
            if (cluSize == 2 * dupli)
            {
              hGlobalResClu2La3->Fill(minres);
            }
            if (cluSize == 3 * dupli)
            {
              hGlobalResClu3La3->Fill(minres);
            }
          }
          else if (rpcId.station() == 2 && rpcId.layer() == 2)
          {
            if (cluSize == 1 * dupli)
            {
              hGlobalResClu1La4->Fill(minres);
            }
            if (cluSize == 2 * dupli)
            {
              hGlobalResClu2La4->Fill(minres);
            }
            if (cluSize == 3 * dupli)
            {
              hGlobalResClu3La4->Fill(minres);
            }
          }
          else if (rpcId.station() == 3)
          {
            if (cluSize == 1 * dupli)
            {
              hGlobalResClu1La5->Fill(minres);
            }
            if (cluSize == 2 * dupli)
            {
              hGlobalResClu2La5->Fill(minres);
            }
            if (cluSize == 3 * dupli)
            {
              hGlobalResClu3La5->Fill(minres);
            }
          }
          else if (rpcId.station() == 4)
          {
            if (cluSize == 1 * dupli)
            {
          ...
          if (debug)
            std::cout << "DT \t \t \t \t \t Filling high resolution histograms with distbord=" << distbord << " cosal="
                << cosal << " cls=" << cluSize << std::endl;

          if (rpcId.station() == 1 && rpcId.layer() == 1)
          {
            ScatterPlotAlphaPCLSLa1->Fill(anglep, cluSize);
            ScatterPlotAlphaCLSLa1->Fill(angle, cluSize);
            if (cluSize == 1 * dupli)
            {
              AngClu1La1->Fill(angle);
              DistBorderClu1La1->Fill(distbord);
            }
            if (cluSize == 2 * dupli)
            {
              AngClu2La1->Fill(angle);
              DistBorderClu2La1->Fill(distbord);
            }
            if (cluSize == 3 * dupli)
            {
              AngClu3La1->Fill(angle);
              DistBorderClu3La1->Fill(distbord);
            }
          }
          else if (rpcId.station() == 1 && rpcId.layer() == 2)
          {
            ScatterPlotAlphaPCLSLa2->Fill(anglep, cluSize);
            ScatterPlotAlphaCLSLa2->Fill(angle, cluSize);
            if (cluSize == 1 * dupli)
            {
              AngClu1La2->Fill(angle);
              DistBorderClu1La2->Fill(distbord);
            }
            if (cluSize == 2 * dupli)
            {
              AngClu2La2->Fill(angle);
              DistBorderClu2La2->Fill(distbord);
            }
            if (cluSize == 3 * dupli)
            {
              AngClu3La2->Fill(angle);
              DistBorderClu3La2->Fill(distbord);
            }
          }
          else if (rpcId.station() == 2 && rpcId.layer() == 1)
          {
            ScatterPlotAlphaPCLSLa3->Fill(anglep, cluSize);
            ScatterPlotAlphaCLSLa3->Fill(angle, cluSize);
            if (cluSize == 1 * dupli)
            {
              AngClu1La3->Fill(angle);
              DistBorderClu1La3->Fill(distbord);
            }
            if (cluSize == 2 * dupli)
            {
              AngClu2La3->Fill(angle);
              DistBorderClu2La3->Fill(distbord);
            }
            if (cluSize == 3 * dupli)
            {
              AngClu3La3->Fill(angle);
              DistBorderClu3La3->Fill(distbord);
            }
          }
          else if (rpcId.station() == 2 && rpcId.layer() == 2)
          {
            ScatterPlotAlphaPCLSLa4->Fill(anglep, cluSize);
            ScatterPlotAlphaCLSLa4->Fill(angle, cluSize);
            if (cluSize == 1 * dupli)
            {
              AngClu1La4->Fill(angle);
              DistBorderClu1La4->Fill(distbord);
            }
            if (cluSize == 2 * dupli)
            {
              AngClu2La4->Fill(angle);
              DistBorderClu2La4->Fill(distbord);
            }
            if (cluSize == 3 * dupli)
            {
              AngClu3La4->Fill(angle);
              DistBorderClu3La4->Fill(distbord);
            }
          }
          else if (rpcId.station() == 3)
          {
            ScatterPlotAlphaPCLSLa5->Fill(anglep, cluSize);
            ScatterPlotAlphaCLSLa5->Fill(angle, cluSize);
            if (cluSize == 1 * dupli)
            {
              AngClu1La5->Fill(angle);
              DistBorderClu1La5->Fill(distbord);
            }
            if (cluSize == 2 * dupli)
            {
              AngClu2La5->Fill(angle);
              DistBorderClu2La5->Fill(distbord);
            }
            if (cluSize == 3 * dupli)
            {
              AngClu3La5->Fill(angle);
              DistBorderClu3La5->Fill(distbord);
            }
          }
          else if (rpcId.station() == 4)
          {
            ...
            if (cluSize == 1 * dupli)
            {
              AngClu1La6->Fill(angle);
              DistBorderClu1La6->Fill(distbord);
            }
            if (cluSize == 2 * dupli)
            {
              AngClu2La6->Fill(angle);
              DistBorderClu2La6->Fill(distbord);
            }
            if (cluSize == 3 * dupli)
            {
              AngClu3La6->Fill(angle);
              DistBorderClu3La6->Fill(distbord);
            }
          }
        }
        ...
        if (debug)
          std::cout << "DT \t \t \t \t \t Filling Residuals " << meIdRPC << std::endl;

        sprintf(meIdRPC, "RPCDataOccupancy_%s", detUnitLabel);
        meMap[meIdRPC]->Fill(stripPredicted);

        if (debug)
          std::cout << "DT \t \t \t \t \t COINCIDENCE!!! Event=" << iEvent.id() << " Filling RPC Data Occupancy for "
              << meIdRPC << " with " << stripPredicted << std::endl;
      ...
      else if (prediction)
      {
        ...
        if (debug)
          std::cout << "DT \t \t \t \t \t A roll was ineficient in event " << iEvent.id().event() << std::endl;
        if (debug)
          ofrej << "DTs \t Wh " << rpcId.ring() << "\t St " << rpcId.station() << "\t Se " << rpcId.sector()
              << "\t Roll " << nameRoll << "\t Event " << iEvent.id().event() << "\t Run " << iEvent.id().run()
              << std::endl;
      }
    }
  }
  ...
  {
    if (debug)
      std::cout << "DT This Event doesn't have any DT4DDSegment" << std::endl; //is ther more than 1 segment in this event?
  }

  //From Now on CSC part!

  if (rpcCSCPoints.isValid())
    if (rpcCSCPoints->begin() != rpcCSCPoints->end())
    {//No Empty Predictions
      RPCRecHitCollection::const_iterator rpcPoint;
...
std::cout << "find coincidence in csc and rpc" << std::endl;
          ...
          if (rpcStation == 1)
            stationstatistics->Fill(10);
          if (rpcStation == 2)
            stationstatistics->Fill(11);
          if (rpcStation == 3)
            stationstatistics->Fill(12);
          if (rpcStation == 4)
            stationstatistics->Fill(13);
        }
        ...
        if (debug)
        {
          ...
          std::cout << "CSC  \t \t \t \t \t Candidate" << rpcId << " " << "(from CSC Segment) STRIP---> "
              << stripPredicted << std::endl;//
        }
        ...
        bool prediction = false;
         ...
         std::cout << "CSC \t \t \t \t Extrapolating near last strip, Event" << iEvent.id() << " stripPredicted="
         << stripPredicted << " Number of strips=" << rollasociated->nstrips() << std::endl;
         if (fabs(stripPredicted) < 1. && debug)
         std::cout << "CSC \t \t \t \t Extrapolating near first strip, Event" << iEvent.id() << " stripPredicted="
         << stripPredicted << " Number of strips=" << rollasociated->nstrips() << std::endl;

         sprintf(meIdCSC, "ExpectedOccupancy_%s", detUnitLabel);
         if (debug)
         std::cout << "CSC \t \t \t \t Filling Expected for " << meIdCSC << " with " << stripPredicted << std::endl;
        ...
        {
          if (debug)
            std::cout << "CSC \t \t \t \t \t THIS ROLL DOESN'T HAVE ANY RECHIT" << std::endl;
        }
        else
        {
          assert(minres != 3000);
           ...
           std::cout << "CSC  \t \t \t \t \t Minimal Residual less than stripw*rangestrips? minres=" << minres
        ...
        if (prediction && anycoincidence)
        {
          ...
          if (inves)
          {
            ...
            float angle = acos(cosal) * 180 / 3.1415926;
            if (debug)
              std::cout << "CSC \t \t \t \t \t Angle=" << angle << " degree" << std::endl;
          ...
          if (debug)
            std::cout << "CSC \t \t \t \t \t \t COINCEDENCE!!! Event=" << iEvent.id()
                << "Filling Filling RPC Data Occupancy for " << meIdRPC << " with " << stripPredicted << std::endl;
        }

        if (anycoincidence)
        {
          if (debug)
            std::cout << "CSC \t \t \t \t \t \t Filling 2D histo for RPC Occupancy " << meIdRPC << std::endl;
          sprintf(meIdRPC, "RPCDataOccupancy2D_%s", detUnitLabel);
          meMap[meIdRPC]->Fill(PointExtrapolatedRPCFrame.x(), PointExtrapolatedRPCFrame.y());
        }
        else if (prediction)
