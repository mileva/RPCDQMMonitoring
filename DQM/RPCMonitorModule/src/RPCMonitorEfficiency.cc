...
// $Id: RPCMonitorEfficiency.cc,v 1.62 2012/07/24 09:38:20 carrillo Exp $
//
//
...
public:
  ...
  // Structure for Piet --------------------
  TDirectoryFile * TDir_Efficiency;
  TDirectoryFile * TDir_Statistics;
  TDirectoryFile * TDir_Residuals;
  TDirectoryFile * TDir_Clustersize;
  TDirectoryFile * TDir_BXDistributions;
  TDirectoryFile * TDir_SummaryHistograms;
  TDirectoryFile * TDir_MuonRadiographies;
  TDirectoryFile * TDir_Pigi; 
  TDirectoryFile * TDir_Greg;
  TDirectoryFile * TDir_Rest;
  // ---------------------------------------
  ...
  // Cosine of incident angle in Barrel
  TH1F * CosAngMB3MB4, * CosAngMB3MB4Whm2, * CosAngMB3MB4Whm1, * CosAngMB3MB4Wh0, * CosAngMB3MB4Wh1, * CosAngMB3MB4Wh2;
  TH1F * MeanResiduals, * MeanResiduals11, * AllResidualsBarrel, * AllResidualsEndCap;
  TH1F * RMSResiduals, * RMSResiduals11;
  // BX in Barrel and Endcap
  TH2F * bxbarrel, * bxendcap, * signal_bxbarrel, * signal_bxendcap;
  TH1F * EndcapEffTot, * EffBarrelRoll, * HitDen, * CSCDen, * EfficiencyPerLayer, * StatisticsPerLayer;
  TH1F * ExpLayerWm2, * ExpLayerWm1, * ExpLayerW0, * ExpLayerW1, * ExpLayerW2;
  TH1F * ObsLayerWm2, * ObsLayerWm1, * ObsLayerW0, * ObsLayerW1, * ObsLayerW2;


  // MUO 11-001 Paper
  TH1F *   residualStation1Ring2_A, * residualStation1Ring2_B, *   residualStation1Ring2_C, *  residualStation1Ring3_A, *  residualStation1Ring3_B, *  residualStation1Ring3_C; 			  	
  TH1F *  residualStation23Ring2_A, * residualStation23Ring2_B, *  residualStation23Ring2_C, * residualStation23Ring3_A, * residualStation23Ring3_B, * residualStation23Ring3_C;
  TH1F * residualStation123Ring3_A, * residualStation123Ring3_B, * residualStation123Ring3_C;
  TH1F *  residualRB1in, * residualRB1out, *  residualRB2in, * residualRB2out, *    residualRB3, *    residualRB4;

  //Other residuals  
  TH1F * residualDiskp1Ring2, * residualDiskp1Ring3, * residualDiskp2Ring2, * residualDiskp2Ring3, * residualDiskp3Ring2, * residualDiskp3Ring3, * residualDiskp4Ring2, * residualDiskp4Ring3;
  TH1F * residualDiskm1Ring2, * residualDiskm1Ring3, * residualDiskm2Ring2, * residualDiskm2Ring3, * residualDiskm3Ring2, * residualDiskm3Ring3, * residualDiskm4Ring2, * residualDiskm4Ring3;
  ...
  TH1F * EffDistroWm2, * EffDistroWm1, * EffDistroW0, * EffDistroW1, * EffDistroW2;
  TH1F * EffDistroWm2far, * EffDistroWm1far, * EffDistroW0far, * EffDistroW1far, * EffDistroW2far;
  TH1F * DoubleGapDistroWm2, * DoubleGapDistroWm1, * DoubleGapDistroW0, * DoubleGapDistroW1, * DoubleGapDistroW2;
  TH1F * DoubleGapDistroWm2far, * DoubleGapDistroWm1far, * DoubleGapDistroW0far, * DoubleGapDistroW1far, * DoubleGapDistroW2far;
  ...
  TH1F * BXEffPositiveEndCap, * BXEffNegativeEndCap, * badBXEffPositiveEndCap, * badBXEffNegativeEndCap;
  TH2F * HeightVsEffR2, * HeightVsEffR3;

  TH1F * GregD1R2, * GregD1R3, * GregD2R2, * GregD2R3, * GregD3R2, * GregD3R3;  
  TH1F * GregD1R2_black, * GregD1R3_black, * GregD2R2_black, * GregD2R3_black, * GregD3R2_black, * GregD3R3_black;   // For black list
  TH1F * OcGregD1R2, * OcGregD1R3, * OcGregD2R2, * OcGregD2R3, * OcGregD3R2, * OcGregD3R3;  
  TH1F * ExGregD1R2, * ExGregD1R3, * ExGregD2R2, * ExGregD2R3, * ExGregD3R2, * ExGregD3R3;  
  TH1F * GregDm1R2, * GregDm1R3, * GregDm2R2, * GregDm2R3, * GregDm3R2, * GregDm3R3;
  TH1F * GregDm1R2_black, * GregDm1R3_black, * GregDm2R2_black, * GregDm2R3_black, * GregDm3R2_black, * GregDm3R3_black;   //For black list
  TH1F * OcGregDm1R2, * OcGregDm1R3, * OcGregDm2R2, * OcGregDm2R3, * OcGregDm3R2, * OcGregDm3R3;  
  TH1F * ExGregDm1R2, * ExGregDm1R3, * ExGregDm2R2, * ExGregDm2R3, * ExGregDm3R2, * ExGregDm3R3;  
  TH1F * CLSWm2, * CLSWm1, * CLSW0, * CLSW1, * CLSW2;
  TH1F * CLSWm2layer, * CLSWm1layer, * CLSW0layer, * CLSW1layer, * CLSW2layer;
  TH1F * CLSStation1Ring2_A, * CLSStation1Ring2_B, * CLSStation1Ring2_C;
  TH1F * CLSStation23Ring2_A, * CLSStation23Ring2_B, * CLSStation23Ring2_C;
  TH1F * CLSStation123Ring3_A, * CLSStation123Ring3_B, * CLSStation123Ring3_C;
  TH1F * sectorCLSWm2[13], * sectorCLSWm1[13], * sectorCLSW0[13], * sectorCLSW1[13], * sectorCLSW2[13];
  TH1F * layerCLSWm2[7], * layerCLSWm1[7], * layerCLSW0[7], * layerCLSW1[7], * layerCLSW2[7], * CLSlayer[7];
  TH1F * CLS;
  TH1F * sectorEffWm2, * sectorEffWm1, * sectorEffW0, * sectorEffW1, * sectorEffW2;  
  TH1F * OcsectorEffWm2, * OcsectorEffWm1, * OcsectorEffW0, * OcsectorEffW1, * OcsectorEffW2;  
  TH1F * ExsectorEffWm2, * ExsectorEffWm1, * ExsectorEffW0, * ExsectorEffW1, * ExsectorEffW2;  
  TH1F * EffDistroDm4, * EffDistroDm3, * EffDistroDm2, * EffDistroDm1, * EffDistroD1, * EffDistroD2, * EffDistroD3, * EffDistroD4;
  TH1F * EffDistroDm4far, * EffDistroDm3far, * EffDistroDm2far, * EffDistroDm1far, * EffDistroD1far, * EffDistroD2far, * EffDistroD3far, * EffDistroD4far;
  ...
  TH2F * Wheelm2Summary, * Wheelm1Summary, * Wheel0Summary, * Wheel1Summary, * Wheel2Summary;
  TH2F * Diskm4Summary, * Diskm3Summary, * Diskm2Summary, * Diskm1Summary, * Diskp1Summary, * Diskp2Summary, * Diskp3Summary, * Diskp4Summary;
  TH2F * PositiveEndCapSummary, * NegativeEndCapSummary;
  TH1F * histoRPC, * histoDT, * histoCSC, * histoPRO, * histoPROY, * histoPROX, * histoCellDistro, * histoRES;
  TH2F * histoRPC_2D, * histoDT_2D, * histoCSC_2D, * histoPRO_2D;
  TH1F * BXDistribution, * Signal_BXDistribution, * histoRealRPC, * histoResidual, * histoResidual1, * histoResidual2, * histoResidual3, * histoResidualO, * histoCLS; 
  TH2F * histoBXY, * histoINEF;
  TH1F * EffGlobWm2, * EffGlobWm1, * EffGlobW0, * EffGlobW1, * EffGlobW2;
  TH1F * EffGlobWm2far, * EffGlobWm1far, * EffGlobW0far, * EffGlobW1far, * EffGlobW2far;
  TH1F * DoubleGapWm2, * DoubleGapWm1, * DoubleGapW0, * DoubleGapW1, * DoubleGapW2;
  TH1F * DoubleGapWm2far, * DoubleGapWm1far, * DoubleGapW0far, * DoubleGapW1far, * DoubleGapW2far;
  TH1F * BXGlobWm2, * BXGlobWm1, * BXGlobW0, * BXGlobW1, * BXGlobW2;
  TH1F * BXGlobWm2far, * BXGlobWm1far, * BXGlobW0far, * BXGlobW1far, * BXGlobW2far;
  TH1F * Signal_BXGlobWm2, * Signal_BXGlobWm1, * Signal_BXGlobW0, * Signal_BXGlobW1, * Signal_BXGlobW2;
  TH1F * Signal_BXGlobWm2far, * Signal_BXGlobWm1far, * Signal_BXGlobW0far, * Signal_BXGlobW1far, * Signal_BXGlobW2far;
  TH1F * MaskedGlobWm2, * MaskedGlobWm1, * MaskedGlobW0, * MaskedGlobW1, * MaskedGlobW2;
  TH1F * MaskedGlobWm2far, * MaskedGlobWm1far, * MaskedGlobW0far, * MaskedGlobW1far, * MaskedGlobW2far;
  TH1F * AverageEffWm2, * AverageEffWm1, * AverageEffW0, * AverageEffW1, * AverageEffW2;
  TH1F * AverageEffWm2far, * AverageEffWm1far, * AverageEffW0far, * AverageEffW1far, * AverageEffW2far;
  TH1F * NoPredictionWm2, * NoPredictionWm1, * NoPredictionW0, * NoPredictionW1, * NoPredictionW2;
  TH1F * NoPredictionWm2far, * NoPredictionWm1far, * NoPredictionW0far, * NoPredictionW1far, * NoPredictionW2far;

  TH1F * EffGlobDm4,* EffGlobDm3, * EffGlobDm2, * EffGlobDm1, * EffGlobD1, * EffGlobD2, * EffGlobD3, * EffGlobD4;
  TH1F * EffGlobDm4far,* EffGlobDm3far, * EffGlobDm2far, * EffGlobDm1far, * EffGlobD1far, * EffGlobD2far, * EffGlobD3far, * EffGlobD4far;
  TH1F * BXGlobDm4, * BXGlobDm3, * BXGlobDm2, * BXGlobDm1, * BXGlobD1, * BXGlobD2, * BXGlobD3, * BXGlobD4;
  TH1F * BXGlobDm4far, * BXGlobDm3far, * BXGlobDm2far, * BXGlobDm1far, * BXGlobD1far, * BXGlobD2far, * BXGlobD3far, * BXGlobD4far;
  TH1F * Signal_BXGlobDm4, * Signal_BXGlobDm3, * Signal_BXGlobDm2, * Signal_BXGlobDm1, * Signal_BXGlobD1, * Signal_BXGlobD2, * Signal_BXGlobD3, * Signal_BXGlobD4;
  TH1F * Signal_BXGlobDm4far, * Signal_BXGlobDm3far, * Signal_BXGlobDm2far, * Signal_BXGlobDm1far, * Signal_BXGlobD1far, * Signal_BXGlobD2far, * Signal_BXGlobD3far, * Signal_BXGlobD4far;
  TH1F * MaskedGlobDm4, * MaskedGlobDm3, * MaskedGlobDm2, * MaskedGlobDm1, * MaskedGlobD1, * MaskedGlobD2, * MaskedGlobD3, * MaskedGlobD4;
  TH1F * MaskedGlobDm4far, * MaskedGlobDm3far, * MaskedGlobDm2far, * MaskedGlobDm1far, * MaskedGlobD1far, * MaskedGlobD2far, * MaskedGlobD3far, * MaskedGlobD4far;
  TH1F * AverageEffDm4, * AverageEffDm3, * AverageEffDm2, * AverageEffDm1, * AverageEffD1, * AverageEffD2, * AverageEffD3, * AverageEffD4;
  TH1F * AverageEffDm4far, * AverageEffDm3far, * AverageEffDm2far, * AverageEffDm1far, * AverageEffD1far, * AverageEffD2far, * AverageEffD3far, * AverageEffD4far;
  TH1F * NoPredictionDm4, * NoPredictionDm3, * NoPredictionDm2, * NoPredictionDm1, * NoPredictionD1, * NoPredictionD2, * NoPredictionD3, * NoPredictionD4;
  TH1F * NoPredictionDm4far, * NoPredictionDm3far, * NoPredictionDm2far, * NoPredictionDm1far, * NoPredictionD1far, * NoPredictionD2far, * NoPredictionD3far, * NoPredictionD4far;

  TH2F * ScatterPlotAlphaCLSLa1, * ScatterPlotAlphaCLSLa2, * ScatterPlotAlphaCLSLa3, * ScatterPlotAlphaCLSLa4, * ScatterPlotAlphaCLSLa5, * ScatterPlotAlphaCLSLa6;
  TH2F * ScatterPlotAlphaPCLSLa1, * ScatterPlotAlphaPCLSLa2, * ScatterPlotAlphaPCLSLa3, * ScatterPlotAlphaPCLSLa4, * ScatterPlotAlphaPCLSLa5, * ScatterPlotAlphaPCLSLa6;
  TH1F * DistBorderClu1La1, * DistBorderClu1La2, * DistBorderClu1La3, * DistBorderClu1La4, * DistBorderClu1La5, * DistBorderClu1La6;
  TH1F * DistBorderClu2La1, * DistBorderClu2La2, * DistBorderClu2La3, * DistBorderClu2La4, * DistBorderClu2La5, * DistBorderClu2La6;
  TH1F * DistBorderClu3La1, * DistBorderClu3La2, * DistBorderClu3La3, * DistBorderClu3La4, * DistBorderClu3La5, * DistBorderClu3La6;
  TPaveText * pave;
...
void RPCMonitorEfficiency::beginRun(const edm::Run&,const edm::EventSetup&){
  ...
  TDir_Efficiency = new TDirectoryFile("Efficiency", "Efficiency");
  TDir_Statistics = new TDirectoryFile("Statistics", "Statistics");
  TDir_Residuals = new TDirectoryFile("Residuals", "Residuals");
  TDir_Clustersize = new TDirectoryFile("Clustersize", "Clustersize");
  TDir_BXDistributions = new TDirectoryFile("BXDistributions", "BXDistributions");
  TDir_SummaryHistograms = new TDirectoryFile("SummaryHistograms", "SummaryHistograms");
  TDir_MuonRadiographies = new TDirectoryFile("MuonRadiographies", "MuonRadiographies");
  TDir_Pigi = new TDirectoryFile("RequestedPlots_Pigi", "RequestedPlots_Pigi");
  TDir_Greg = new TDirectoryFile("RequestedPlots_Greg", "RequestedPlots_Greg");
  TDir_Rest = new TDirectoryFile("UnsortedPlots", "UnsortedPlots");
...
void RPCMonitorEfficiency::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup){
  ...
  residualDiskp1Ring2  = new TH1F("residualDiskp1Ring2","Residuals for Disk +1 Ring 2",101,-20.,20.);
  residualDiskp1Ring3  = new TH1F("residualDiskp1Ring3","Residuals for Disk +1 Ring 3",101,-20.,20.);
  residualDiskp2Ring2  = new TH1F("residualDiskp2Ring2","Residuals for Disk +2 Ring 2",101,-20.,20.);
  residualDiskp2Ring3  = new TH1F("residualDiskp2Ring3","Residuals for Disk +2 Ring 3",101,-20.,20.);
  residualDiskp3Ring2  = new TH1F("residualDiskp3Ring2","Residuals for Disk +3 Ring 2",101,-20.,20.);
  residualDiskp3Ring3  = new TH1F("residualDiskp3Ring3","Residuals for Disk +3 Ring 3",101,-20.,20.);
  residualDiskp4Ring2  = new TH1F("residualDiskp4Ring2","Residuals for Disk +4 Ring 2",101,-20.,20.);
  residualDiskp4Ring3  = new TH1F("residualDiskp4Ring3","Residuals for Disk +4 Ring 3",101,-20.,20.);
  ...
  os="Efficiency_Roll_vs_Sector_Disk_+1";                                      
  Diskp1Summary = new TH2F (os.c_str(), os.c_str(), 36, 0.5,36.5, 6, 0.5, 6.5);
  os="Efficiency_Roll_vs_Sector_Disk_+2";                                      
  Diskp2Summary = new TH2F (os.c_str(), os.c_str(), 36, 0.5,36.5, 6, 0.5, 6.5);
  os="Efficiency_Roll_vs_Sector_Disk_+3";                                      
  Diskp3Summary = new TH2F (os.c_str(), os.c_str(), 36, 0.5,36.5, 6, 0.5, 6.5);
  os="Efficiency_Roll_vs_Sector_Disk_+4";                                      
  Diskp4Summary = new TH2F (os.c_str(), os.c_str(), 36, 0.5,36.5, 6, 0.5, 6.5);
  ...
  Ca4->Clear();
  // meIdRES  = folder + "UnixEventTime";
  // unixtime = (TH1F*)theFile->Get(meIdRES.c_str());
  // unixtime->Draw();
  // unixtime->Write();
  ...
  for(int i=1;i<=36;i++){
    binLabel.str("");
    binLabel<<i;
    Diskm4Summary->GetXaxis()->SetBinLabel(i,binLabel.str().c_str());
    ...
    Diskp1Summary->GetXaxis()->SetBinLabel(i,binLabel.str().c_str());
    Diskp2Summary->GetXaxis()->SetBinLabel(i,binLabel.str().c_str());
    Diskp3Summary->GetXaxis()->SetBinLabel(i,binLabel.str().c_str());
    Diskp4Summary->GetXaxis()->SetBinLabel(i,binLabel.str().c_str());
  ...
  for(int ri=2;ri<=3;ri++){
    for(int roll=1;roll<=3;roll++){
      ...
      Diskm4Summary->GetYaxis()->SetBinLabel((ri-2)*3+roll,binLabel.str().c_str());
      ...
      Diskp1Summary->GetYaxis()->SetBinLabel((ri-2)*3+roll,binLabel.str().c_str());
      Diskp2Summary->GetYaxis()->SetBinLabel((ri-2)*3+roll,binLabel.str().c_str());
      Diskp3Summary->GetYaxis()->SetBinLabel((ri-2)*3+roll,binLabel.str().c_str());
      Diskp4Summary->GetYaxis()->SetBinLabel((ri-2)*3+roll,binLabel.str().c_str());
    }
  }
...
//rumi	    RollYEff<<name<<" "<<pinoeff<<" "<<pinoerr<<" "<<pinoexpected<<" "<<histoCLS->GetMean()<<" ";
	    RollYEff<<name << " " << rpcId.rawId() <<" "<<pinoeff<<" "<<pinoerr<<" "<<pinoexpected<<" "<<histoCLS->GetMean()<<" ";
...
//Cesare
	  ...
	  std::cout<<"Pigi Check "<<name<<" "<<rpcsrv.shortname()<<" "<<(*r)->id();
	  ...
	  if(histoRPC_2D && histoCSC_2D && histoResidual && endcap){
	    ...
	    if(rpcId.region()==1){
	      if(rpcId.station()==1 && rpcId.ring()==2) residualDiskp1Ring2->Add(histoResidual);
	      if(rpcId.station()==1 && rpcId.ring()==3) residualDiskp1Ring3->Add(histoResidual);
	      if(rpcId.station()==2 && rpcId.ring()==2) residualDiskp2Ring2->Add(histoResidual);
	      if(rpcId.station()==2 && rpcId.ring()==3) residualDiskp2Ring3->Add(histoResidual);
	      if(rpcId.station()==3 && rpcId.ring()==2) residualDiskp3Ring2->Add(histoResidual);
	      if(rpcId.station()==3 && rpcId.ring()==3) residualDiskp3Ring3->Add(histoResidual);
	      if(rpcId.station()==4 && rpcId.ring()==2) residualDiskp4Ring2->Add(histoResidual);
	      if(rpcId.station()==4 && rpcId.ring()==3) residualDiskp4Ring3->Add(histoResidual);
	    }
	    if(rpcId.region()==-1){
...
//rumi	    RollYEff<<name<<" "<<pinoeff<<" "<<pinoerr<<" "<<pinoexpected<<" "<<histoCLS->GetMean()<<" ";
	  ...
	  if(histoRPC && histoCSC && BXDistribution && histoRealRPC && Signal_BXDistribution){
	    ...
	    if(sector==1||sector==2||sector==6){
	      if(Disk==-4){EffDistroDm4->Fill(pinoeff);
	      }else if(Disk==-3){EffDistroDm3->Fill(pinoeff);
	      ...
	      }else if(Disk==4){EffDistroD4->Fill(pinoeff);
	      }
	    }else{//Far Side 
	      if(Disk==-4){EffDistroDm4far->Fill(pinoeff);
	      }else if(Disk==-3){EffDistroDm3far->Fill(pinoeff);
	      ...
	      }else if(Disk==4){EffDistroD4far->Fill(pinoeff);
	      }
	    }
	  ...
	  // if(debug) 
	  std::cout<<"Pigi "<<camera<<" "<<rpcsrv.shortname()<<" "<<(*r)->id()<<" ef="<<pinoeff<<" Y="<<Y<<std::endl;
	  ...
	  else if(Disk==1)  Diskp1Summary->SetBinContent(rpcsrv.segment(),Y,pinoeff);
	  else if(Disk==2)  Diskp2Summary->SetBinContent(rpcsrv.segment(),Y,pinoeff);
	  else if(Disk==3)  Diskp3Summary->SetBinContent(rpcsrv.segment(),Y,pinoeff);
	  else if(Disk==4)  Diskp4Summary->SetBinContent(rpcsrv.segment(),Y,pinoeff);
	  ...
	  if(sector==1||sector==2||sector==6){
	    if(Disk==-4){
	      indexDisk[6]++;  
	      EffGlobDm4->SetBinContent(indexDisk[6],pinoeff);  
	      EffGlobDm4->SetBinError(indexDisk[6],pinoerr);  
	      EffGlobDm4->GetXaxis()->SetBinLabel(indexDisk[6],camera.c_str());
            
	      BXGlobDm4->SetBinContent(indexDisk[6],mybxhisto);  
	      BXGlobDm4->SetBinError(indexDisk[6],mybxerror);  
	      BXGlobDm4->GetXaxis()->SetBinLabel(indexDisk[6],camera.c_str());

	      Signal_BXGlobDm4->SetBinContent(indexDisk[6],signal_mybxhisto);  
	      Signal_BXGlobDm4->SetBinError(indexDisk[6],signal_mybxerror);  
	      Signal_BXGlobDm4->GetXaxis()->SetBinLabel(indexDisk[6],camera.c_str());
      
	      MaskedGlobDm4->SetBinContent(indexDisk[6],maskedratio);  
	      MaskedGlobDm4->GetXaxis()->SetBinLabel(indexDisk[6],camera.c_str());

	      AverageEffDm4->SetBinContent(indexDisk[6],averageeff);
	      AverageEffDm4->SetBinError(indexDisk[6],averageerr);  
	      AverageEffDm4->GetXaxis()->SetBinLabel(indexDisk[6],camera.c_str());
	      
	      if(debug) std::cout<<"Filling Problematic Histogram with"<<nopredictionsratio<<std::endl;
	      NoPredictionDm4->SetBinContent(indexDisk[6],nopredictionsratio);
              NoPredictionDm4->GetXaxis()->SetBinLabel(indexDisk[6],camera.c_str());
	    }else if(Disk==-3){
	      indexDisk[0]++;  
	      ...
	      indexDisk[7]++;
	      EffGlobD4->SetBinContent(indexDisk[7],pinoeff);
	      EffGlobD4->SetBinError(indexDisk[7],pinoerr);
	      EffGlobD4->GetXaxis()->SetBinLabel(indexDisk[7],camera.c_str());

	      BXGlobD4->SetBinContent(indexDisk[7],mybxhisto);  
	      BXGlobD4->SetBinError(indexDisk[7],mybxerror);  
	      BXGlobD4->GetXaxis()->SetBinLabel(indexDisk[7],camera.c_str());

	      Signal_BXGlobD4->SetBinContent(indexDisk[7],signal_mybxhisto);  
	      Signal_BXGlobD4->SetBinError(indexDisk[7],signal_mybxerror);  
	      Signal_BXGlobD4->GetXaxis()->SetBinLabel(indexDisk[7],camera.c_str());

	      MaskedGlobD4->SetBinContent(indexDisk[7],maskedratio);  
	      MaskedGlobD4->GetXaxis()->SetBinLabel(indexDisk[7],camera.c_str());

	      AverageEffD4->SetBinContent(indexDisk[7],averageeff);
	      AverageEffD4->SetBinError(indexDisk[7],averageerr);  
	      AverageEffD4->GetXaxis()->SetBinLabel(indexDisk[7],camera.c_str());
	      
	      NoPredictionD4->SetBinContent(indexDisk[7],nopredictionsratio);
              NoPredictionD4->GetXaxis()->SetBinLabel(indexDisk[7],camera.c_str());	      
	    ...
	    if(Disk==-4){
	      indexDiskf[6]++;  
	      EffGlobDm4far->SetBinContent(indexDiskf[6],pinoeff);  
	      EffGlobDm4far->SetBinError(indexDiskf[6],pinoerr);  
	      EffGlobDm4far->GetXaxis()->SetBinLabel(indexDiskf[6],camera.c_str());

	      BXGlobDm4far->SetBinContent(indexDiskf[6],mybxhisto);  
	      BXGlobDm4far->SetBinError(indexDiskf[6],mybxerror);  
	      BXGlobDm4far->GetXaxis()->SetBinLabel(indexDiskf[6],camera.c_str());
	      
	      Signal_BXGlobDm4far->SetBinContent(indexDiskf[6],signal_mybxhisto);  
	      Signal_BXGlobDm4far->SetBinError(indexDiskf[6],signal_mybxerror);  
	      Signal_BXGlobDm4far->GetXaxis()->SetBinLabel(indexDiskf[6],camera.c_str());
	      
	      MaskedGlobDm4far->SetBinContent(indexDiskf[6],maskedratio);
	      MaskedGlobDm4far->GetXaxis()->SetBinLabel(indexDiskf[6],camera.c_str());
	      
	      AverageEffDm4far->SetBinContent(indexDiskf[6],averageeff);
              AverageEffDm4far->SetBinError(indexDiskf[6],averageerr);
              AverageEffDm4far->GetXaxis()->SetBinLabel(indexDiskf[6],camera.c_str());

              NoPredictionDm4far->SetBinContent(indexDisk[0],nopredictionsratio);
              NoPredictionDm4far->GetXaxis()->SetBinLabel(indexDisk[0],camera.c_str());
	      ...
	      indexDiskf[7]++;
	      EffGlobD4far->SetBinContent(indexDiskf[7],pinoeff);
	      EffGlobD4far->SetBinError(indexDiskf[7],pinoerr);
	      EffGlobD4far->GetXaxis()->SetBinLabel(indexDiskf[7],camera.c_str());

	      BXGlobD4far->SetBinContent(indexDiskf[7],mybxhisto);  
	      BXGlobD4far->SetBinError(indexDiskf[7],mybxerror);  
	      BXGlobD4far->GetXaxis()->SetBinLabel(indexDiskf[7],camera.c_str());

	      Signal_BXGlobD4far->SetBinContent(indexDiskf[7],signal_mybxhisto);  
	      Signal_BXGlobD4far->SetBinError(indexDiskf[7],signal_mybxerror);  
	      Signal_BXGlobD4far->GetXaxis()->SetBinLabel(indexDiskf[7],camera.c_str());
	      
	      MaskedGlobD4far->SetBinContent(indexDiskf[7],maskedratio);
	      MaskedGlobD4far->GetXaxis()->SetBinLabel(indexDiskf[7],camera.c_str());

	      AverageEffD4far->SetBinContent(indexDiskf[7],averageeff);
              AverageEffD4far->SetBinError(indexDiskf[7],averageerr);
              AverageEffD4far->GetXaxis()->SetBinLabel(indexDiskf[7],camera.c_str());

              NoPredictionD4far->SetBinContent(indexDiskf[7],nopredictionsratio);
              NoPredictionD4far->GetXaxis()->SetBinLabel(indexDiskf[7],camera.c_str());
	    }
	  }//Finishing EndCap
	}
      }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if(barrel){
    ...
    residualDiskp1Ring2->Write(); 
    residualDiskp1Ring3->Write(); 
    residualDiskp2Ring2->Write(); 
    residualDiskp2Ring3->Write(); 
    residualDiskp3Ring2->Write(); 
    residualDiskp3Ring3->Write(); 
  ...
  residualDiskp1Ring2->Draw();  labeltoSave = "resEndCap/residualDiskp1Ring2.png"; residualDiskp1Ring2->GetXaxis()->SetTitle("(cm)");   if(residualDiskp1Ring2->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  residualDiskp1Ring3->Draw();  labeltoSave = "resEndCap/residualDiskp1Ring3.png"; residualDiskp1Ring3->GetXaxis()->SetTitle("(cm)");   if(residualDiskp1Ring3->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  residualDiskp2Ring2->Draw();  labeltoSave = "resEndCap/residualDiskp2Ring2.png"; residualDiskp2Ring2->GetXaxis()->SetTitle("(cm)");   if(residualDiskp2Ring2->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  residualDiskp2Ring3->Draw();  labeltoSave = "resEndCap/residualDiskp2Ring3.png"; residualDiskp2Ring3->GetXaxis()->SetTitle("(cm)");   if(residualDiskp2Ring3->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  residualDiskp3Ring2->Draw();  labeltoSave = "resEndCap/residualDiskp3Ring2.png"; residualDiskp3Ring2->GetXaxis()->SetTitle("(cm)");   if(residualDiskp3Ring2->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  residualDiskp3Ring3->Draw();  labeltoSave = "resEndCap/residualDiskp3Ring3.png"; residualDiskp3Ring3->GetXaxis()->SetTitle("(cm)");   if(residualDiskp3Ring3->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  residualDiskp4Ring2->Draw();  labeltoSave = "resEndCap/residualDiskp4Ring2.png"; residualDiskp4Ring2->GetXaxis()->SetTitle("(cm)");   if(residualDiskp4Ring2->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  residualDiskp4Ring3->Draw();  labeltoSave = "resEndCap/residualDiskp4Ring3.png"; residualDiskp4Ring3->GetXaxis()->SetTitle("(cm)");   if(residualDiskp4Ring3->GetEntries()!=0) Ca7->SetLogy();   Ca7->SaveAs(labeltoSave.c_str()); Ca7->Clear();
  ...
  delete residualDiskp1Ring2;
  delete residualDiskp1Ring3;
  delete residualDiskp2Ring2;
  delete residualDiskp2Ring3;
  delete residualDiskp3Ring2;
  delete residualDiskp3Ring3;
  delete residualDiskp4Ring2;
  delete residualDiskp4Ring3;
...
//rumi
std::cout << "pass rumi check 1" << std::endl;
      for(int i=1;i<=IntegralMuography[m]->GetXaxis()->GetNbins();++i){
std::cout << i << "\tpass rumi check 2" << std::endl;
  ...
  */
  ...
  // gStyle->SetGridStyle(0);    // no grid
  // gStyle->SetGridStyle(3);    // dashed grid
  ...
  Ca5->SaveAs("Pigi/Diskm4Summary.root"); 
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Diskm3Summary.root"); 
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Diskm2Summary.root");  
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Diskm1Summary.root"); 
  Ca5->Clear();
  
  Diskp4Summary->SetMinimum(0); 
  Diskp4Summary->SetMaximum(100);
  Diskp4Summary->Draw(); Diskp4Summary->GetXaxis()->SetTitle("Chamber");
  Diskp4Summary->SetDrawOption("COLZ");
  Ca5->SetTicks(1,1);
  Ca5->SaveAs("Pigi/Disk4Summary.png"); 
  Ca5->SaveAs("Pigi/Disk4Summary.root"); 
  Ca5->Clear();

  Diskp3Summary->SetMinimum(0); 
  Diskp3Summary->SetMaximum(100);
  Diskp3Summary->Draw(); Diskp3Summary->GetXaxis()->SetTitle("Chamber");
  Diskp3Summary->SetDrawOption("COLZ");
  Ca5->SetTicks(1,1);
  Ca5->SaveAs("Pigi/Disk3Summary.png"); 
  Ca5->SaveAs("Pigi/Disk3Summary.root"); 
  Ca5->Clear();
  
  Diskp2Summary->SetMinimum(0); 
  Diskp2Summary->SetMaximum(100);
  Diskp2Summary->Draw(); Diskp2Summary->GetXaxis()->SetTitle("Chamber");
  Diskp2Summary->SetDrawOption("COLZ");
  Ca5->SetTicks(1,1);
  Ca5->SaveAs("Pigi/Disk2Summary.png"); 
  Ca5->SaveAs("Pigi/Disk2Summary.root"); 
  Ca5->Clear();
  
  Diskp1Summary->SetMinimum(0); 
  Diskp1Summary->SetMaximum(100);
  Diskp1Summary->Draw(); Diskp1Summary->GetXaxis()->SetTitle("Chamber");
  Diskp1Summary->SetDrawOption("COLZ");
  Ca5->SetTicks(1,1);
  Ca5->SaveAs("Pigi/Disk1Summary.png"); 
  Ca5->SaveAs("Pigi/Disk1Summary.root"); 
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/PositiveEndCapSummary.root"); 
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/NegativeEndCapSummary.root"); 
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Wheelm2Summary.root");  
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Wheelm1Summary.root");  
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Wheel0Summary.root");  
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Wheel1Summary.root");   
  Ca5->Clear();
  ...
  Ca5->SaveAs("Pigi/Wheel2Summary.root"); 
  Ca5->Clear();
